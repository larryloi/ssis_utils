CREATE PROCEDURE [dbo].[ds_sp_etl_data_process_completed_at] (@database_name NVARCHAR(128), @schema_name NVARCHAR(128), @table_name NVARCHAR(128), @data_process_completed_at DATETIME = NULL OUTPUT)
AS 
BEGIN
SET NOCOUNT ON;
